...
const razorpay = new Razorpay({
  ...
  key_id: 'rzp_test_Rp42r0Aqd3EZrY',

  key_secret: '10FbavAMxpgDor4tQk1ARVGc',
...
app.post('/api/bookings/verify', async (req, res) => {
  ...
  try {
    ...
    const expectedSignature = crypto.createHmac('sha256', '10FbavAMxpgDor4tQk1ARVGc').update(body.toString()).digest('hex');
...
app.get('/api/admin/manifest', async (req, res) => {
  ...
  // 6. Admin History (Strict: Only PAID & PAST trips)
